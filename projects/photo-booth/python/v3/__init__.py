...
# initialize TKinter
screen 			= Tk()
screen.title('Lillian\'s Birthday Photo Booth!')
label 			= Label(screen, text="This is our first GUI!")
label.pack()
button_start	= Button(screen, text="Start", command=start)
button_start.pack()
button_end		= Button(screen, text="End/Quit", command=end)
button_end.pack()
screen.mainloop()
# End TKinter
